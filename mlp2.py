...
def main(args):
    ...
    #                       max_depth=5,
    #                       gamma=10)
    model = MLPClassifier(hidden_layer_sizes=[100, 50], activation='relu', solver='adam', alpha=0.0001, batch_size=8, learning_rate='constant', learning_rate_init=0.001, power_t=0.5, max_iter=200, shuffle=True, random_state=None, tol=0.0001, verbose=True, warm_start=False, momentum=0.9, nesterovs_momentum=True, early_stopping=True, validation_fraction=0.1, beta_1=0.9, beta_2=0.999, epsilon=1e-08, n_iter_no_change=10, max_fun=15000)
